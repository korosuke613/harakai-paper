...
\begin{thebibliography}{0}
  \bibitem{modelica_beginners_book}
  ...
  \bibitem{ipa_useful_modelbase_dev}
  ...
  \bibitem{open_modelica}
  ``Welcome to OpenModelica - OpenModelica'', https://openmodelica.org, アクセス日:2020/02/07
  \end{thebibliography}
